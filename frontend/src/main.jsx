...
class ErrorBoundary extends React.Component {
  ...
  componentDidCatch(error, info) { console.error("FATAL REACT CAUGHT:", error, info); fetch(`http://${window.location.hostname}:5173/__error`, { method: 'POST', body: error.stack }); }
  render() {
